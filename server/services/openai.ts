...
class OpenAIService {
  ...
  async generateRichOutline(
    ...
    const sys = [
      this.getPersonaPrompt(persona, tone),
      "You will produce a professional, research-grounded presentation outline.",
      "Rules:",
      "- Use any 'Research context:' text in the topic within at least 7 slide bodies.",
      "- Cite ideas to the research context narratively (no bracketed citations).",
      "- Do NOT fabricate data; include chartSpec only if grounded.",
      "- Each slide must have a unique, non-redundant title.",
      "- Avoid repetitive phrasing; bullets are punchy, 3–6 items.",
      "",
        ...
        slides: {
          ...
          items: {
            ...
            properties: {
              ...
              body: { type: "string", minLength: 700 },
              bullets: {
                type: "array",
                minItems: 3,
                maxItems: 6,
