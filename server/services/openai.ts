...
class OpenAIService {
  ...
  async generateRichOutline(
    ...
    const sys = [
      this.getPersonaPrompt(persona, tone),
      "You will produce a professional, research-grounded presentation outline with DEEP ANALYSIS.",
      "",
      ...
      "5. STRUCTURE: Use research context in at least 7 slide bodies with narrative citations.",
      "",
      "FORBIDDEN (will cause rejection):",
      "- Meta language: 'This slide will...', 'presentation', 'template', 'will include', 'will describe'",
      "- Placeholders: 'TBD', 'to be determined', 'example data', '[insert]'",
      ...
      "- Each body must be 700+ chars of substantive analysis (not padding)",
      "- Bullets must be concrete findings/actions, not vague statements",
